...
\setbeamertemplate{footline}{%
  ...
  \hbox{%
    \begin{beamercolorbox}[wd=.55\paperwidth,ht=2.25ex,dp=1ex,leftskip=1em]{footer}%
      \footnotesize\color{solBase01}\titlemono\small MTA\mdash{}Sitzung 3\normalsize%
    \end{beamercolorbox}%
...
\subtitle{Sitzung 3\mdash{}Vorverarbeitung, Metadaten\\und ein kritischer Blick auf Topic-Modelle}
...
% ===============================================================
\begin{frame}{TF-IDF \mdash{} eine zentrale Gewichtung}
...
% ===============================================================
\begin{frame}{Lemmatisierung, NER, Phrasen \mdash{} optionale Schritte}
...
% ===============================================================
\begin{frame}{Strategie 1 \mdash{} \emph{Spaltung}}
...
% ===============================================================
\begin{frame}{Strategie 2 \mdash{} \emph{Hinzufügung}}
...
% ===============================================================
\begin{frame}{Strategie 3 \mdash{} \emph{Lernergänzung}}
...
\begin{frame}{Topic-Modelle haben Grenzen}
  ...
  Zwei verbreitete Erwartungen werden dort behandelt. Beide werden
  Sie in der Literatur und in der Praxis immer wieder hören. Die
  erste muss man \emph{nuancieren}, die zweite muss man \emph{klar
  zurückweisen}.
...
% ===============================================================
\begin{frame}{Erwartung 1 \mdash{} \enquote{Brücke zwischen Quali und Quanti?}}

  Das Argument: Da Topic-Modelle Statistik und Mathematik einsetzen,
  \textbf{lösen sie} das alte Paar \emph{qualitativ vs.\ quantitativ}
  \textbf{vollständig auf}.

  \vfill
  \textbf{Diese starke Version ist falsch} (Buch, S.~152) – aber eine
  schwächere Version ist begründet. Topic-Modelle eröffnen tatsächlich
  \emph{methodische Brücken} zwischen qualitativer und quantitativer
  Forschung:
  \begin{itemize}
    \item Formale Nähe zur \emph{Faktorenanalyse}: in beiden Fällen
          Reduktion einer hochdimensionalen Datenmatrix auf wenige
          latente Dimensionen.
    \vfill
    \item In MTA selbst: \textbf{Mittelwerttests} auf den
          Dokument-Topic-Gewichten (Welch-t-Test, BH-Korrektur) –
          ein klassisch quantitatives Verfahren auf Daten qualitativer
          Herkunft.
    \vfill
    \item Topic-Gewichte als \textbf{Inputs für eine
          Hauptkomponentenanalyse}, um Korpora in einem reduzierten
          Raum zu vergleichen.
  \end{itemize}
...
% ===============================================================
\begin{frame}{Erwartung 1 \mdash{} Pointe}

  Topic-Modelle sind \emph{kein} Brückenschlag, der die Unterscheidung
  qualitativ/quantitativ \emph{aufhebt}. Aber sie ermöglichen
  \textbf{Anschlüsse} zwischen beiden Traditionen – auf eine Art, die
  ältere qualitative Verfahren (Oevermann, Mayring) so nicht erlauben.

  \vfill
  \begin{block}{Was bleibt richtig}
    Die qualitative Arbeit am \emph{Sinn} von Begriffen bleibt
    unverzichtbar. Texte lassen sich nicht auf eine einzige Bedeutung
    reduzieren, und die methodische Brücke entbindet nicht von der
    hermeneutischen Lektüre.

    \medskip
    Topic-Modelle sind nicht \emph{a priori} \enquote{besser} oder
    \enquote{neutraler}, weil sie mit Zahlen arbeiten.
  \end{block}

\end{frame}

% ===============================================================
\begin{frame}{Erwartung 2 \mdash{} \enquote{Interpretation auf ein Minimum reduzieren}}
...
\begin{frame}{Eine Pflichtlektüre: Schmidt 2012}
  ...
  \begin{block}{Schmidt 2012 \mdash{} die Kritik}
...
% ===============================================================
\begin{frame}{Was wir gelernt haben \mdash{} Bilanz der drei Sitzungen}
