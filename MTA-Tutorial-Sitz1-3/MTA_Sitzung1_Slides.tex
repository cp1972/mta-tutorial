...
% ---------------------------------------------------------------
% xelatex compilation -- bessere Typographie, native Unicode-Unterstützung
\usepackage{fontspec}
\usepackage[ngerman,provide=*]{babel}
\usepackage{csquotes}

% ---------------------------------------------------------------
% Beamer-Theme: schlicht, akademisch, heller Hintergrund
% ---------------------------------------------------------------
\usetheme{default}
\usecolortheme{dove}
...
% Schmale, dezente Fußzeile mit Sitzungstitel und Seitennummer
\setbeamertemplate{footline}{%
  \leavevmode%
  \hbox{%
    \begin{beamercolorbox}[wd=.55\paperwidth,ht=2.25ex,dp=1ex,leftskip=1em]{author in head/foot}%
      \footnotesize\color{black!60}MTA -- Sitzung 1: Topic-Modelle als qualitative Methode%
    \end{beamercolorbox}%
...
\subtitle{Sitzung 1 -- Positionierung gegenüber\\objektiver Hermeneutik und qualitativer Inhaltsanalyse}
