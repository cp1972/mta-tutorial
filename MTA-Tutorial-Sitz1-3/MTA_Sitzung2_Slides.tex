...
\setbeamertemplate{footline}{%
  ...
  \hbox{%
    \begin{beamercolorbox}[wd=.55\paperwidth,ht=2.25ex,dp=1ex,leftskip=1em]{footer}%
      \footnotesize\color{solBase01}\titlemono\small MTA\mdash{}Sitzung 2\normalsize%
    \end{beamercolorbox}%
...
\subtitle{Sitzung 2\mdash{}Mathematische Grundlagen,\\LDA, NMF und der Sprung zu BERT/LLMs}
...
\begin{frame}{LDA \mdash{} Latent Dirichlet Allocation}
...
% ===============================================================
\begin{frame}{LDA \mdash{} die Berechnung in einem Satz}
...
% ===============================================================
\begin{frame}{NMF \mdash{} Non-Negative Matrix Factorization}
...
% ===============================================================
\begin{frame}{LDA vs.\ NMF \mdash{} praktischer Vergleich}
...
% ===============================================================
\begin{frame}{BERTopic vs.\ LDA/NMF \mdash{} die Forschungslage}
...
\begin{frame}{Aber: erste empirische Kritik}
  ...
  \begin{block}{Ashwin, Chhabra \& Rao (2025) \mdash{} \emph{Sociological Methods \& Research}}
